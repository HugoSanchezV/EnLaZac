...
//       listeners: {
//         accept: () => {
//           const url = route("technical.routers.destroy", id);
        ...
        >
          ...
          <td v-for="(cell, cellIndex) in row" :key="cellIndex">
            <div v-if="cellIndex === 'sync'">
              <Link
                v-if="edit"
                :href="route('technical.routers.sync', row.id)"
          ...
          <td class="flex items-stretch">
            <div class="sm:flex gap-4 flex flex-wrap actions">
              ...
              <Link
                :href="route('technical.routers.devices', row.id)"
                v-if="row.sync"
              ...
              <Link
                :href="route('technical.routers.ping', row.id)"
