            ...
            <div class="text-center sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div>
                ...
                <ul class="record-list">
                  ...
                  <li v-for="(ticket, index) in tickets" :key="ticket.id" class="record-item">
                    <div class="record-info">
                      <p><strong>Asunto: {{ ticket.subject }}</strong> De {{ ticket.user.name }}</p>
                    </div>
                    <!-- Botón Mostrar -->
                    <Link  :href="route('tickets.show', ticket.id)"  class="show-button">Mostrar</Link>
                  </li>
                </ul>
              </div>
            </div>
