            ...
            <div class="text-center sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div>
                ...
                <ul class="record-list">
                  ...
                  <li v-for="(user, index) in users" :key="user.id" class="record-item">
                    <div class="record-info">
                      <p><strong>{{ user.id }}:</strong> {{ user.name }}</p>
                    </div>
                    <!-- Botón Mostrar -->
                     <div class="flex gap-1">
                       <Link  :href="route('usuarios.show', user.id)" class="show-button">Mostrar</Link>
                       <Link  :href="route('usuarios.show', user.id)" class="show-button-consumo">Consumo</Link>
