...
<template>
  <div>
    <sidebar-area ref="holaRef" class="bg-white"></sidebar-area>
    <header-area @cambio="cambio"></header-area>
  </div>
  <div>
    <Head :title="title" />
          ...
          <div class="flex justify-between h-16">
            <div class="flex">
              ...
              <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                <NavLink
                  :href="route('inventorie.devices.index')"
                  :active="route().current('inventorie.devices.index')"
                >
                  Inventario
                </NavLink>
              </div>
...
export default {
  methods: {
    cambio() {
      console.log(this.$refs.holaRef.toggleSidebarState());
    },
  },

  mounted() {
    console.log(this.$refs.holaRef.message);
  },
};
</script>
