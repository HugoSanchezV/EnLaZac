...
class TechnicalInventorieDevicesController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Tecnico/InventorieDevices/Index', [
            'devices' => $devices,
            'pagination' => [
    ...
    {
        return Inertia::render('Tecnico/InventorieDevices/Create');
    }
    ...
    public function show(string $id)
    {
        ...
        return Inertia::render('Tecnico/InventorieDevices/Show', [
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Tecnico/InventorieDevices/Edit', [
            'device' => $device
        ]);
    }
